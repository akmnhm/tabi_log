		...
		<td class="icon">
		  ...
		  <tr>
			...
			onmouseover="changclass('itta');" onmouseout="resetclass('itta');">
		      <?php echo Html::anchor("members/userpg/myself/itta", "行った")?></td>
		    <?php endif ?>
			...
			onmouseover="changclass('photo');" onmouseout="resetclass('photo');">
		      <?php echo Html::anchor("members/userpg/myself/photo", "写真")?></td>
		    <?php endif ?>
		  </tr><tr>
		    <!-- post check -->
		    <?php if($page_num == 3): ?>
			...
			onmouseover="changclass('post');" onmouseout="resetclass('post');">
		      <?php echo Html::anchor("members/userpg/myself/posts", "ポスト")?></td>
		    <?php endif ?>
			...
			onmouseover="changclass('review');" onmouseout="resetclass('review');">
		      <?php echo Html::anchor("members/userpg/myself/reviews", "レビュー")?></td>
		    <?php endif ?>

		    <!-- change check -->
		    <?php if($page_num == 5): ?>
		    <td id="change" class="button current">変更</td>
		    <?php else: ?>
		    <td id="change" class="button not_curr"
			onmouseover="changclass('change');" onmouseout="resetclass('change');">
		      <?php echo Html::anchor("members/userpg/myself/change", "変更")?></td>
		    <?php endif ?>
		  </tr>
		</table>
	      </tr>
